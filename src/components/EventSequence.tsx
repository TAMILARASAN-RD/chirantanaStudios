...
export default function EventSequence() {
  ...
  useEffect(() => {
    // Import all images from the event folder
    const imageModules = import.meta.glob('../event/*.jpg', { eager: true, query: '?url', import: 'default' });
  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden bg-brand-light">
      <canvas 
        ref={canvasRef} 
