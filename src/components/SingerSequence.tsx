...
export default function SingerSequence() {
  ...
  useEffect(() => {
    // Import all images from the singers folder
    const imageModules = import.meta.glob('../singers/*.jpg', { eager: true, query: '?url', import: 'default' });
