...
export default function ElectionRallySequence() {
  ...
  useEffect(() => {
    // Import all images from the election rally folder
    const imageModules = import.meta.glob('../election rally/*.jpg', { eager: true, query: '?url', import: 'default' });
